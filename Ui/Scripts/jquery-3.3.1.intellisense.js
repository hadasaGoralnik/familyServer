intellisense.annotate(jQuery, {
  ...
  'holdReady': function() {
    /// <signature>
    ///   <summary>Holds or releases the execution of jQuery's ready Events.</summary>
  ...
  'when': function() {
    /// <signature>
    ///   <summary>Provides a way to execute callback functions based on one or more objects, usually Deferred objects that represent asynchronous Eventss.</summary>
...
intellisense.annotate(jQuery.Events.prototype, {
  'currentTarget': function() {
    /// <summary>The current DOM element within the Events bubbling phase.</summary>
    /// <returns type="Element" />
  },
  'data': function() {
    /// <summary>An optional object of data passed to an Events method when the current executing handler is bound.</summary>
    /// <returns type="Object" />
  },
  'delegateTarget': function() {
    /// <summary>The element where the currently-called jQuery Events handler was attached.</summary>
    /// <returns type="Element" />
  },
  'isDefaultPrEventsed': function() {
    /// <summary>Returns whether Events.prEventsDefault() was ever called on this Events object.</summary>
    /// <returns type="Boolean" />
  },
  'isImmediatePropagationStopped': function() {
    /// <summary>Returns whether Events.stopImmediatePropagation() was ever called on this Events object.</summary>
    /// <returns type="Boolean" />
  },
  'isPropagationStopped': function() {
    /// <summary>Returns whether Events.stopPropagation() was ever called on this Events object.</summary>
    /// <returns type="Boolean" />
  },
  'metaKey': function() {
    /// <summary>Indicates whether the META key was pressed when the Events fired.</summary>
    /// <returns type="Boolean" />
  },
  'namespace': function() {
    /// <summary>The namespace specified when the Events was triggered.</summary>
    /// <returns type="String" />
  },
  'pageX': function() {
  ...
  'prEventsDefault': function() {
    /// <summary>If this method is called, the default action of the Events will not be triggered.</summary>
  },
  'relatedTarget': function() {
    /// <summary>The other DOM element involved in the Events, if any.</summary>
    /// <returns type="Element" />
  },
  'result': function() {
    /// <summary>The last value returned by an Events handler that was triggered by this Events, unless the value was undefined.</summary>
    /// <returns type="Object" />
  },
  'stopImmediatePropagation': function() {
    /// <summary>Keeps the rest of the handlers from being executed and prEventss the Events from bubbling up the DOM tree.</summary>
  },
  'stopPropagation': function() {
    /// <summary>PrEventss the Events from bubbling up the DOM tree, prEventsing any parent handlers from being notified of the Events.</summary>
  },
  'target': function() {
    /// <summary>The DOM element that initiated the Events.</summary>
    /// <returns type="Element" />
  },
  'timeStamp': function() {
    /// <summary>The difference in milliseconds between the time the browser created the Events and January 1, 1970.</summary>
    /// <returns type="Number" />
  },
  'type': function() {
    /// <summary>Describes the nature of the Events.</summary>
    /// <returns type="String" />
  },
  'which': function() {
    /// <summary>For key or mouse Eventss, this property indicates the specific key or button that was pressed.</summary>
    /// <returns type="Number" />
  },
});
...
intellisense.annotate(jQuery.fn, {
  ...
  'ajaxComplete': function() {
    /// <signature>
    ///   <summary>Register a handler to be called when Ajax requests complete. This is an AjaxEvents.</summary>
    ///   <param name="handler(Events, XMLHttpRequest, ajaxOptions)" type="Function">The function to be invoked.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'ajaxError': function() {
    /// <signature>
    ///   <summary>Register a handler to be called when Ajax requests complete with an error. This is an Ajax Events.</summary>
    ///   <param name="handler(Events, jqXHR, ajaxSettings, thrownError)" type="Function">The function to be invoked.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'ajaxSend': function() {
    /// <signature>
    ///   <summary>Attach a function to be executed before an Ajax request is sent. This is an Ajax Events.</summary>
    ///   <param name="handler(Events, jqXHR, ajaxOptions)" type="Function">The function to be invoked.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'ajaxStart': function() {
    /// <signature>
    ///   <summary>Register a handler to be called when the first Ajax request begins. This is an Ajax Events.</summary>
  ...
  'ajaxStop': function() {
    /// <signature>
    ///   <summary>Register a handler to be called when all Ajax requests have completed. This is an Ajax Events.</summary>
    ///   <param name="handler()" type="Function">The function to be invoked.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'ajaxSuccess': function() {
    /// <signature>
    ///   <summary>Attach a function to be executed whenever an Ajax request completes successfully. This is an Ajax Events.</summary>
    ///   <param name="handler(Events, XMLHttpRequest, ajaxOptions)" type="Function">The function to be invoked.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'bind': function() {
    /// <signature>
    ///   <summary>Attach a handler to an Events for the elements.</summary>
    ///   <param name="EventsType" type="String">A string containing one or more DOM Events types, such as "click" or "submit," or custom Events names.</param>
    ///   <param name="EventsData" type="Object">An object containing data that will be passed to the Events handler.</param>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Attach a handler to an Events for the elements.</summary>
    ///   <param name="EventsType" type="String">A string containing one or more DOM Events types, such as "click" or "submit," or custom Events names.</param>
    ///   <param name="EventsData" type="Object">An object containing data that will be passed to the Events handler.</param>
    ///   <param name="prEventsBubble" type="Boolean">Setting the third argument to false will attach a function that prEventss the default action from occurring and stops the Events from bubbling. The default is true.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Attach a handler to an Events for the elements.</summary>
    ///   <param name="Eventss" type="Object">An object containing one or more DOM Events types and functions to execute for them.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'blur': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "blur" JavaScript Events, or trigger that Events on an element.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'change': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "change" JavaScript Events, or trigger that Events on an element.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'click': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "click" JavaScript Events, or trigger that Events on an element.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'clone': function() {
    ...
    ///   <param name="withDataAndEventss" type="Boolean">A Boolean indicating whether Events handlers should be copied along with the elements. As of jQuery 1.4, element data will be copied as well.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Create a deep copy of the set of matched elements.</summary>
    ///   <param name="withDataAndEventss" type="Boolean">A Boolean indicating whether Events handlers and data should be copied along with the elements. The default value is false. *In jQuery 1.5.0 the default value was incorrectly true; it was changed back to false in 1.5.1 and up.</param>
    ///   <param name="deepWithDataAndEventss" type="Boolean">A Boolean indicating whether Events handlers and data for all children of the cloned element should be copied. By default its value matches the first argument's value (which defaults to false).</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'closest': function() {
  ...
  'dblclick': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "dblclick" JavaScript Events, or trigger that Events on an element.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'delegate': function() {
    /// <signature>
    ///   <summary>Attach a handler to one or more Eventss for all elements that match the selector, now or in the future, based on a specific set of root elements.</summary>
    ///   <param name="selector" type="String">A selector to filter the elements that trigger the Events.</param>
    ///   <param name="EventsType" type="String">A string containing one or more space-separated JavaScript Events types, such as "click" or "keydown," or custom Events names.</param>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute at the time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Attach a handler to one or more Eventss for all elements that match the selector, now or in the future, based on a specific set of root elements.</summary>
    ...
    ///   <summary>Attach a handler to one or more Eventss for all elements that match the selector, now or in the future, based on a specific set of root elements.</summary>
    ///   <param name="selector" type="String">A selector to filter the elements that trigger the Events.</param>
    ///   <param name="Eventss" type="PlainObject">A plain object of one or more Events types and functions to execute for them.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'dequeue': function() {
  ...
  'die': function() {
    /// <signature>
    ///   <summary>Remove Events handlers previously attached using .live() from the elements.</summary>
    ///   <param name="EventsType" type="String">A string containing a JavaScript Events type, such as click or keydown.</param>
    ///   <param name="handler" type="String">The function that is no longer to be executed.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove Events handlers previously attached using .live() from the elements.</summary>
    ///   <param name="Eventss" type="PlainObject">A plain object of one or more Events types, such as click or keydown and their corresponding functions that are no longer to be executed.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'disabled': function() {
  ...
  'error': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "error" JavaScript Events.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute when the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Bind an Events handler to the "error" JavaScript Events.</summary>
  ...
  'focus': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "focus" JavaScript Events, or trigger that Events on an element.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'focusin': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "focusin" Events.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'focusout': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "focusout" JavaScript Events.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'hover': function() {
    ...
    ///   <param name="handlerIn(EventsObject)" type="Function">A function to execute when the mouse pointer enters the element.</param>
    ///   <param name="handlerOut(EventsObject)" type="Function">A function to execute when the mouse pointer leaves the element.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'html': function() {
  ...
  'keydown': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "keydown" JavaScript Events, or trigger that Events on an element.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Bind an Events handler to the "keydown" JavaScript Events, or trigger that Events on an element.</summary>
    ///   <param name="EventsData" type="PlainObject">An object containing data that will be passed to the Events handler.</param>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'keypress': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "keypress" JavaScript Events, or trigger that Events on an element.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'keyup': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "keyup" JavaScript Events, or trigger that Events on an element.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'live': function() {
    /// <signature>
    ///   <summary>Attach an Events handler for all elements which match the current selector, now and in the future.</summary>
    ///   <param name="Eventss" type="String">A string containing a JavaScript Events type, such as "click" or "keydown." As of jQuery 1.4 the string can contain multiple, space-separated Events types or custom Events names.</param>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute at the time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Attach an Events handler for all elements which match the current selector, now and in the future.</summary>
    ///   <param name="Eventss" type="String">A string containing a JavaScript Events type, such as "click" or "keydown." As of jQuery 1.4 the string can contain multiple, space-separated Events types or custom Events names.</param>
    ///   <param name="data" type="PlainObject">An object containing data that will be passed to the Events handler.</param>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute at the time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Attach an Events handler for all elements which match the current selector, now and in the future.</summary>
    ///   <param name="Eventss" type="PlainObject">A plain object of one or more JavaScript Events types and functions to execute for them.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'load': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "load" JavaScript Events.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute when the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'mousedown': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "mousedown" JavaScript Events, or trigger that Events on an element.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'mouseenter': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to be fired when the mouse enters an element, or trigger that handler on an element.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'mouseleave': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to be fired when the mouse leaves an element, or trigger that handler on an element.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'mousemove': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "mousemove" JavaScript Events, or trigger that Events on an element.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'mouseout': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "mouseout" JavaScript Events, or trigger that Events on an element.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'mouseover': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "mouseover" JavaScript Events, or trigger that Events on an element.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'mouseup': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "mouseup" JavaScript Events, or trigger that Events on an element.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'off': function() {
    /// <signature>
    ///   <summary>Remove an Events handler.</summary>
    ///   <param name="Eventss" type="String">One or more space-separated Events types and optional namespaces, or just namespaces, such as "click", "keydown.myPlugin", or ".myPlugin".</param>
    ///   <param name="selector" type="String">A selector which should match the one originally passed to .on() when attaching Events handlers.</param>
    ///   <param name="handler(EventsObject)" type="Function">A handler function previously attached for the Events(s), or the special value false.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove an Events handler.</summary>
    ///   <param name="Eventss" type="PlainObject">An object where the string keys represent one or more space-separated Events types and optional namespaces, and the values represent handler functions previously attached for the Events(s).</param>
    ///   <param name="selector" type="String">A selector which should match the one originally passed to .on() when attaching Events handlers.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'on': function() {
    /// <signature>
    ///   <summary>Attach an Events handler function for one or more Eventss to the selected elements.</summary>
    ///   <param name="Eventss" type="String">One or more space-separated Events types and optional namespaces, such as "click" or "keydown.myPlugin".</param>
    ///   <param name="selector" type="String">A selector string to filter the descendants of the selected elements that trigger the Events. If the selector is null or omitted, the Events is always triggered when it reaches the selected element.</param>
    ///   <param name="data" type="Anything">Data to be passed to the handler in Events.data when an Events is triggered.</param>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute when the Events is triggered. The value false is also allowed as a shorthand for a function that simply does return false.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Attach an Events handler function for one or more Eventss to the selected elements.</summary>
    ///   <param name="Eventss" type="PlainObject">An object in which the string keys represent one or more space-separated Events types and optional namespaces, and the values represent a handler function to be called for the Events(s).</param>
    ...
    ///   <param name="data" type="Anything">Data to be passed to the handler in Events.data when an Events occurs.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'one': function() {
    /// <signature>
    ///   <summary>Attach a handler to an Events for the elements. The handler is executed at most once per element.</summary>
    ///   <param name="Eventss" type="String">A string containing one or more JavaScript Events types, such as "click" or "submit," or custom Events names.</param>
    ///   <param name="data" type="PlainObject">An object containing data that will be passed to the Events handler.</param>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute at the time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'resize': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "resize" JavaScript Events, or trigger that Events on an element.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'scroll': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "scroll" JavaScript Events, or trigger that Events on an element.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'select': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "select" JavaScript Events, or trigger that Events on an element.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'submit': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "submit" JavaScript Events, or trigger that Events on an element.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'trigger': function() {
    /// <signature>
    ///   <summary>Execute all handlers and behaviors attached to the matched elements for the given Events type.</summary>
    ///   <param name="EventsType" type="String">A string containing a JavaScript Events type, such as click or submit.</param>
    ///   <param name="extraParameters" type="">Additional parameters to pass along to the Events handler.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Execute all handlers and behaviors attached to the matched elements for the given Events type.</summary>
    ///   <param name="Events" type="Events">A jQuery.Events object.</param>
    ///   <param name="extraParameters" type="">Additional parameters to pass along to the Events handler.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'triggerHandler': function() {
    /// <signature>
    ///   <summary>Execute all handlers attached to an element for an Events.</summary>
    ///   <param name="EventsType" type="String">A string containing a JavaScript Events type, such as click or submit.</param>
    ///   <param name="extraParameters" type="Array">An array of additional parameters to pass along to the Events handler.</param>
    ///   <returns type="Object" />
    /// </signature>
  },
  'unbind': function() {
    /// <signature>
    ///   <summary>Remove a previously-attached Events handler from the elements.</summary>
    ///   <param name="EventsType" type="String">A string containing a JavaScript Events type, such as click or submit.</param>
    ///   <param name="handler(EventsObject)" type="Function">The function that is to be no longer executed.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove a previously-attached Events handler from the elements.</summary>
    ///   <param name="EventsType" type="String">A string containing a JavaScript Events type, such as click or submit.</param>
    ///   <param name="false" type="Boolean">Unbinds the corresponding 'return false' function that was bound using .bind( EventsType, false ).</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove a previously-attached Events handler from the elements.</summary>
    ///   <param name="Events" type="Object">A JavaScript Events object as passed to an Events handler.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'undelegate': function() {
    /// <signature>
    ///   <summary>Remove a handler from the Events for all elements which match the current selector, based upon a specific set of root elements.</summary>
    ///   <param name="selector" type="String">A selector which will be used to filter the Events results.</param>
    ///   <param name="EventsType" type="String">A string containing a JavaScript Events type, such as "click" or "keydown"</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ...
    ///   <summary>Remove a handler from the Events for all elements which match the current selector, based upon a specific set of root elements.</summary>
    ///   <param name="selector" type="String">A selector which will be used to filter the Events results.</param>
    ///   <param name="Eventss" type="PlainObject">An object of one or more Events types and previously bound functions to unbind from them.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove a handler from the Events for all elements which match the current selector, based upon a specific set of root elements.</summary>
    ///   <param name="namespace" type="String">A string containing a namespace to unbind all Eventss from.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'unload': function() {
    /// <signature>
    ///   <summary>Bind an Events handler to the "unload" JavaScript Events.</summary>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute when the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Bind an Events handler to the "unload" JavaScript Events.</summary>
    ///   <param name="EventsData" type="Object">A plain object of data that will be passed to the Events handler.</param>
    ///   <param name="handler(EventsObject)" type="Function">A function to execute each time the Events is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
